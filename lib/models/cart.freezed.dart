...
// ✅ Ajout du convertisseur ici
  ...
  @override
  String toString() {
    return 'Cart(id: $id, user: $user, items: $items, total: $total, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, user,
      const DeepCollectionEquality().hash(_items), total, createdAt, updatedAt);
